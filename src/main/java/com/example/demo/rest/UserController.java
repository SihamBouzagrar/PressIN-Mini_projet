...
public class UserController {
    ...
    // =========================
    // CREATE LIVREUR (ADMIN ONLY)
    // =========================
    @PostMapping("/admin/create-livreur")
    public ResponseEntity<?> createLivreur(@RequestBody RegisterRequest req) {
        ...
        try {
            ...
            e.printStackTrace();
            return ResponseEntity.status(500).body("Erreur création livreur");
        }
    }
